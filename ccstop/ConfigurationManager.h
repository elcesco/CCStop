...
const char usage_longstr[] = "Usage: ccstop [-s|-c host] [options]\n"
                           ...
                           "\n"
                           "Server or Client:\n"
                           "  -p, --port <portnumber>   server port to listen on/connect to\n"
                           "  -l, --logfile <file>      send output to a log file\n"
                           ...
                           "  -P, --pcap <file>         uses pcap file for ovet channel input\n"
                           "  -S, --script <file>       script file controlling the covert channel inpout\n"
